...
public class ChatService {
    ...
    public ArrayList<String> sendprompt(String id, String prompt, String model ,String email) {
        ...
        if (!chatOpt.isPresent()) {
            ...
            idd.add(newChat.getId().toString());
            idd.add(response.getBody());
        ...
        // ------------------- CASE 2: Append to existing chat -------------------
            ...
            userRepository.save(user);
             ArrayList<String> idd  = new ArrayList<>();
            idd.add(chatOpt.get().getId().toString());
            idd.add(response.getBody());
